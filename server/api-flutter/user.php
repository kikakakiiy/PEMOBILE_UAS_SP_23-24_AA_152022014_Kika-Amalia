...
$sql = "SELECT * FROM login " . $where . " AND role = 'pasien' ORDER BY id DESC LIMIT " . $items_per_page . " OFFSET " . ($page - 1) * $items_per_page;
...
$sql = "SELECT count(id) as total FROM login " . $where;
$result = $conn->query($sql);
